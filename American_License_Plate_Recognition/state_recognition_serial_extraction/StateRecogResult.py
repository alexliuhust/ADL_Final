...
from state_recognition_serial_extraction.StateRecCNN import StateCNN
from state_recognition_serial_extraction.GetFeature import get_edge
from state_recognition_serial_extraction.PrepareData import store_img_in_array
...
def get_state_name(input_image):
    saving_path = './model/sccnn.pth'  # Where to find the saved model
    model = StateCNN()
